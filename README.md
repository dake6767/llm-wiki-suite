...
| 编译 | 从 RAW 提取实体、概念、来源摘要与关联关系，增量合并而非覆盖 | 可审阅、可追溯、相互链接的 Wiki 页面 |
...
Durable Object 存储。敏感知识库可以保持 relay 关闭，只使用本地 Browser、MCP 或 CLI。当然，你也可以自己搭建中继服务器来访问你本地电脑的 WIKI 库
